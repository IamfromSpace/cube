    ...
    impl EquivalenceClass<UF2Symmetry> for G1WideTurn {
        fn get_equivalent(self, sym: &UF2Symmetry) -> G1WideTurn {
            match (sym, self) {
                ...
                (UF2Symmetry::U, G1WideTurn::F2) => G1WideTurn::R2,
                (UF2Symmetry::U, G1WideTurn::Fw2) => G1WideTurn::Rw2,
                (UF2Symmetry::U, G1WideTurn::R2) => G1WideTurn::B2,
                (UF2Symmetry::U, G1WideTurn::Rw2) => G1WideTurn::Bw2,
                (UF2Symmetry::U, G1WideTurn::B2) => G1WideTurn::L2,
                (UF2Symmetry::U, G1WideTurn::Bw2) => G1WideTurn::Lw2,
                (UF2Symmetry::U, G1WideTurn::L2) => G1WideTurn::F2,
                (UF2Symmetry::U, G1WideTurn::Lw2) => G1WideTurn::Fw2,
                ...
                (UF2Symmetry::UPrime, G1WideTurn::F2) => G1WideTurn::L2,
                (UF2Symmetry::UPrime, G1WideTurn::Fw2) => G1WideTurn::Lw2,
                (UF2Symmetry::UPrime, G1WideTurn::R2) => G1WideTurn::F2,
                (UF2Symmetry::UPrime, G1WideTurn::Rw2) => G1WideTurn::Fw2,
                (UF2Symmetry::UPrime, G1WideTurn::B2) => G1WideTurn::R2,
                (UF2Symmetry::UPrime, G1WideTurn::Bw2) => G1WideTurn::Rw2,
                (UF2Symmetry::UPrime, G1WideTurn::L2) => G1WideTurn::B2,
                (UF2Symmetry::UPrime, G1WideTurn::Lw2) => G1WideTurn::Bw2,
                ...
                (UF2Symmetry::UF2, G1WideTurn::F2) => G1WideTurn::L2,
                (UF2Symmetry::UF2, G1WideTurn::Fw2) => G1WideTurn::Lw2,
                (UF2Symmetry::UF2, G1WideTurn::R2) => G1WideTurn::B2,
                (UF2Symmetry::UF2, G1WideTurn::Rw2) => G1WideTurn::Bw2,
                (UF2Symmetry::UF2, G1WideTurn::B2) => G1WideTurn::R2,
                (UF2Symmetry::UF2, G1WideTurn::Bw2) => G1WideTurn::Rw2,
                (UF2Symmetry::UF2, G1WideTurn::L2) => G1WideTurn::F2,
                (UF2Symmetry::UF2, G1WideTurn::Lw2) => G1WideTurn::Fw2,
