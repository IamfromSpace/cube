...
mod tests {
    ...
    quickcheck! {
        fn turns_and_sym_invert_round_trips(pi: CoordWingEdgesLockedEvensUDSliceIndex, t: G1WideTurn, s: U2F2Symmetry) -> bool {
            let p: CoordWingEdgesLockedEvensUDSlice = pi.into();
    ...
    quickcheck! {
        fn perm_and_turn_u2f2_symmetries_are_equivalent(pi: CoordWingEdgesLockedEvensUDSliceIndex, t: G1WideTurn, s: U2F2Symmetry) -> bool {
            let p: CoordWingEdgesLockedEvensUDSlice = pi.into();
