...
impl<Stored: Eq + Hash + Ord + From<Used>, Used: std::fmt::Display + From<Stored> + PG + Copy + EquivalenceClass<Sym> + From<Turn>, Sym: Clone, Turn: Copy> PruningTable<Stored, Used, Sym, Turn> {
